    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(icon: Icon(Icons.file_upload,textDirection: TextDirection.ltr,),
              onPressed:(){
      ...
      drawer: Drawer(
        child: ListView(
          children: <Widget>[
            UserAccountsDrawerHeader(accountName: Text("Mishra"),
              accountEmail: Text("Mishra123@gmail.com"),
            ...
            ListTile(
              ...
              trailing: Icon(Icons.border_outer),
            ),
            ListTile(
              title: Text("Sport Stories"),
              trailing: Icon(Icons.motorcycle),
            ),
            ListTile(
              title: Text("Political Stories"),
              trailing: Icon(Icons.arrow_back_ios),
            ),
            ListTile(
              title: Text("Crime Stories"),
